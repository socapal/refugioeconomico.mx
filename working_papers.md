...
Documentos técnicos de investigación con metodología detallada, análisis completo y evidencia empírica replicable. Versiones preliminares de investigaciones en desarrollo.

---

## 📄 REC-WP-2026-01 · Diciembre 2025

### Áreas Naturales Protegidas y bienestar local en México: Un análisis de impacto causal

<div class="publication-meta">
  <span class="code">REC-WP-2026-01</span> · 
...
Esta investigación evalúa el impacto causal de las Áreas Naturales Protegidas (ANPs) sobre indicadores de bienestar local en México. Utilizando diferencias en diferencias con tratamiento escalonado, se analiza el efecto de la declaratoria de ANPs sobre marginación, ingreso per cápita y acceso a servicios básicos en localidades cercanas.
...
```
Ocampo Palacios, S. (2025). [Título]. Refugio Económico Working Paper 
REC-WP-2025-01. RePEc:rec:wpaper:2025-01
```

---

## Sobre los Working Papers

Los Working Papers de Refugio Económico:

- ✅ Presentan investigación original con metodología detallada
